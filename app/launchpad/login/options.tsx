      ...
      <div className="container">
        ...
        <div className="login-card">
          <p className="description">
            Use the <span className="highlight-text">same email / slack account on your Hackatime account</span> to sign in! 
            You do not need to have a Moonshot account to begin.
          </p>
