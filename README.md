...
### Staging Environment
- Code that lands on the `main` branch is automatically deployed to https://moonshot-staging.hackclub.com
- For access details, see #moonshot-hq in Hack Club Slack

### Production Environment
- Production is deployed at https://moonshot.hackclub.com
